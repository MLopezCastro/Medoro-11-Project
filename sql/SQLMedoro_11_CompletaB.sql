/* =============================================================
   MEDORO 11 - Vistas completas (con versión "Completa" para test)
   Base destino: Sispro_16092025  (cambiá si aplica)
   ============================================================= */
...
/* =============================================================
   V4 – ConCuboSecuenciasBloques_M11_Completa (NUEVA)
   - Colapsa eventos a bloques (día + OT + renglón)
   - Trae Turno/Maquinista/Operario/Motivo (primer registro del bloque)
   - JOIN UNION → saccod1 (por OP numérico)
   - JOIN NEW (dedup) → OP, CodAlfa, CodMaq, Alto, Ancho, AltoV, Fuelle
   - SortKey sin FORMAT
   ============================================================= */
...
/* =============================================================
   V5 – ConCuboSecuenciasBloques_Rango_M11_Completa (NUEVA)
   - Agrega OrdenGlobalText (texto) y SecuenciaGlobalSQL (1..N)
   - Hereda TODO lo de la vista V4_Completa
   ============================================================= */
...
/* =========================
   Checks rápidos opcionales
   ========================= */
-- SELECT TOP 20 ID_Limpio, FechaSecuencia, SecuenciaGlobalSQL,
--        Maquinista, Turno, OP, CodAlfa, CodMaq, Alto, Ancho, AltoV, Fuelle, saccod1
-- FROM dbo.ConCuboSecuenciasBloques_Rango_M11_Completa
-- ORDER BY SecuenciaGlobalSQL;

-- SELECT COUNT(*) FROM dbo.ConCuboSecuenciasBloques_M11_Completa;
-- SELECT COUNT(*) FROM dbo.ConCuboSecuenciasBloques_Rango_M11_Completa;

SELECT TOP 20
  Renglon, ID_Limpio, FechaSecuencia, Turno, Maquinista, Operario, Motivo,
